...
class PatchMerging(nn.Module):
    ...
    def __init__(self, input_resolution, dim):
        ...
        self.dim = dim
        self.reduction = LinearSuper(dim * 4, dim * 2, bias = False)
        self.norm = LayerNormSuper(dim* 4)
    ...
    def set_sample_config(self, sample_embed_dim):
        self.norm.set_sample_config(sample_embed_dim * 4)
        self.reduction.set_sample_config(sample_in_dim = sample_embed_dim * 4, sample_out_dim = sample_embed_dim * 2)
